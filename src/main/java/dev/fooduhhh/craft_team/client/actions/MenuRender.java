...
public class MenuRender {
    private static final MenuHelper.RadialMenu ownerMenu = new MenuHelper.RadialMenu(new MenuHelper.RadialMenu.Option[] {
    ...
    private static final MenuHelper.RadialMenu commandMenu = new MenuHelper.RadialMenu(new MenuHelper.RadialMenu.Option[] {
    ...
    public static void render(GuiGraphics graphics) {
        commandMenu.draw(graphics, cachedCenterX, cachedCenterY);
    }
}
